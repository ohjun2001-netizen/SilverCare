...
namespace Baduk.Replay
{
    public class KifuVRUI : MonoBehaviour
    {
        ...
        GameObject BuildSelectPanel(RectTransform parent)
        {
            ...
            CreateText(prt, "Title", "기보 복기", 36, FontStyle.Bold,
                new Vector2(0, 180), new Vector2(600, 50), Color.white);
            CreateText(prt, "Sub", "감상할 기보를 고르세요", 22, FontStyle.Normal,
                new Vector2(0, 130), new Vector2(600, 36), new Color(0.8f, 0.8f, 0.8f));
            ...
            var backBtn = CreateButton(prt, "로비로 돌아가기", 22,
                new Vector2(0, -220), new Vector2(350, 50));
        ...
        void BuildKifuSelectButtons(List<Kifu> kifus)
        {
            ...
            {
                CreateText(listTr, "Empty", "사용 가능한 기보가 없습니다.", 22, FontStyle.Normal,
